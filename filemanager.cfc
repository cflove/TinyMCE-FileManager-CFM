			...
			<cfelse>
				...
				<cfswitch expression="#local.fileext#">
					...
					<cfcase value="css,swf,js,php,mp3,pdf,cfm,cfc,wav,zip,avi,mov,wmv,doc,docx,eps,flv,fla,ind,jsf,mpeg,ppt,pptx,proj,psd,pst,rar,txt,xls,xlsx">
						<img data-wh="#JSStringFormat('#settings.UserFilesURL#')#" data-file="#JSStringFormat('#local.filepath##this.getall.name#')#" src="img/#lcase(local.fileext)#.png">
					</cfcase>
					<cfdefaultcase>
						<img data-wh="#JSStringFormat('#settings.UserFilesURL#')#" data-file="#JSStringFormat('#local.filepath##this.getall.name#')#" src="img/un.png">
					</cfdefaultcase>
				</cfswitch>
			</cfif>
				<span class="fmname">#this.getall.name#</span>
